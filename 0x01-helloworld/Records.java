...
public class Records {
    ...
    public static Student[] allStudents = new Student[40];
    ...
    public void addNewStudent(String ID, String name, int age, double grade) {
    ...
    public boolean updateStudent(String ID, String name, int age, double grade) {
        boolean found = false;
        for (int i = 0; i < Records.totalStudents; i++) {
            if (Records.allStudents[i] != null && Records.allStudents[i].ID.equals(ID)) {
            ...
            switch (option) {
                case 1: {
                    try {
                        ...
                        try {
                            records.addNewStudent(ID, name, age, grade);
                ...
                case 2: {
                    try {
                        ...
                        double grade = scanner.nextDouble();
                        boolean found = records.updateStudent(ID, name, age, grade);
                ...
                case 3: {
                    try {
                        ...
                        String ID = scanner.next();
                        String studentInfo = records.viewStudent(ID);
